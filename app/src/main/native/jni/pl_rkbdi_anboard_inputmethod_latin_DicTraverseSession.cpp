...
namespace latinime {
    ...
    static void latinime_initDicTraverseSession(JNIEnv *env, jclass clazz, jlong traverseSession,
                                                jlong dictionary, jintArray previousWord,
                                                jint previousWordLength) {
    ...
    static void
    latinime_releaseDicTraverseSession(JNIEnv *env, jclass clazz, jlong traverseSession) {
        DicTraverseSession *ts = reinterpret_cast<DicTraverseSession *>(traverseSession);
    ...
    int register_DicTraverseSession(JNIEnv *env) {
        const char *const kClassPathName = "pl/rkbdi/anboard/inputmethod/latin/DicTraverseSession";
