...
namespace latinime {
    ...
    void
    Dictionary::getSuggestions(ProximityInfo *proximityInfo, DicTraverseSession *traverseSession,
    ...
    bool Dictionary::updateEntriesForWordWithNgramContext(const NgramContext *const ngramContext,
        ...
        TimeKeeper::setCurrentTime();
        return mDictionaryStructureWithBufferPolicy->updateEntriesForWordWithNgramContext(
                ngramContext,
    ...
    void
    Dictionary::getProperty(const char *const query, const int queryLength, char *const outResult,
