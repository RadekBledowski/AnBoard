...
namespace latinime {
    ...
    public:
        ...
        static int
        getPtNodeArraySizeAndAdvancePosition(const uint8_t *const buffer, int *const pos);
        ...
        static int getCharsAndAdvancePosition(const uint8_t *const buffer, const NodeFlags flags,
                                              const int maxLength, const int *const codePointTable,
                                              int *const outBuffer,
                                              int *const pos);
        ...
        static AK_FORCE_INLINE NodeFlags createAndGetFlags(const bool isPossiblyOffensive,
                                                           ...
                                                           const bool hasShortcutTargets,
                                                           const bool hasBigrams,
        ...
        static void readPtNodeInfo(const uint8_t *const dictBuf, const int ptNodePos,
                                   ...
                                   int *const outCodePointCount, int *const outCodePoint,
                                   int *const outProbability,
                                   int *const outChildrenPos, int *const outShortcutPos,
