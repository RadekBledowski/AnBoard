...
namespace latinime {
    ...
    public:
        ...
        void setupForGetSuggestions(const ProximityInfo *pInfo, const int *inputCodePoints,
                                    const int inputSize, const int *const inputXs,
        ...
        ProximityType
        getProximityTypeG(const DicNode *const dicNode, const int childCodePoint) const {
            ...
            for (int i = 0; i < MAX_POINTER_COUNT_G; ++i) {
                ...
                proximityType = mProximityInfoStates[i].getProximityTypeG(pointerId,
                                                                          childCodePoint);
    ...
    private:
        ...
        void
        initializeProximityInfoStates(const int *const inputCodePoints, const int *const inputXs,
                                      const int *const inputYs, const int *const times,
                                      const int *const pointerIds,
                                      const int inputSize, const float maxSpatialDistance,
                                      const int maxPointerCount);
