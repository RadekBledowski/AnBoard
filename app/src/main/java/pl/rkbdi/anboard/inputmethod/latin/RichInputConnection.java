...
import pl.rkbdi.anboard.inputmethod.compat.InputConnectionCompatUtils;
import pl.rkbdi.anboard.inputmethod.latin.common.Constants;
import pl.rkbdi.anboard.inputmethod.latin.common.StringUtils;
import pl.rkbdi.anboard.inputmethod.latin.common.UnicodeSurrogate;
import pl.rkbdi.anboard.inputmethod.latin.inputlogic.PrivateCommandPerformer;
...
import pl.rkbdi.anboard.inputmethod.latin.utils.DebugLogUtils;
import pl.rkbdi.anboard.inputmethod.latin.utils.NgramContextUtils;
import pl.rkbdi.anboard.inputmethod.latin.utils.ScriptUtils;
import pl.rkbdi.anboard.inputmethod.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See pl.rkbdi.anboard.inputmethod.latin.common.Constants.UnicodeSurrogate
