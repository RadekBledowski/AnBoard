...
// raw pointer but provides several methods that handle boundary checking for writing data.
    ...
    public:
        ...
        BufferWithExtendableBuffer(const ReadWriteByteArrayView originalBuffer,
                ...
                : mOriginalBuffer(originalBuffer), mAdditionalBuffer(),
                  mUsedAdditionalBufferSize(0),
        ...
        void readCodePointsAndAdvancePosition(const int maxCodePointCount,
                                              int *const outCodePoints, int *outCodePointCount,
                                              int *const pos) const;
        ...
        bool
        writeCodePointsAndAdvancePosition(const int *const codePoints, const int codePointCount,
