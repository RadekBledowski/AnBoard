...
#include "pl_rkbdi_anboard_inputmethod_latin_BinaryDictionary.h"
...
namespace latinime {
    ...
    static jlong latinime_BinaryDictionary_createOnMemory(JNIEnv *env, jclass clazz,
                                                          jlong formatVersion, jstring locale,
                                                          jobjectArray attributeKeyStringArray,
    ...
    static void latinime_BinaryDictionary_getHeaderInfo(JNIEnv *env, jclass clazz, jlong dict,
                                                        jintArray outHeaderSize,
                                                        jintArray outFormatVersion,
                                                        jobject outAttributeKeys,
    ...
    static void latinime_BinaryDictionary_getSuggestions(JNIEnv *env, jclass clazz, jlong dict,
                                                         jlong proximityInfo,
                                                         jlong dicTraverseSession,
                                                         jintArray xCoordinatesArray,
                                                         jintArray yCoordinatesArray,
                                                         jintArray timesArray,
                                                         jintArray pointerIdsArray,
                                                         jintArray inputCodePointsArray,
                                                         jint inputSize, jintArray suggestOptions,
                                                         jobjectArray prevWordCodePointArrays,
                                                         jbooleanArray isBeginningOfSentenceArray,
                                                         jint prevWordCount,
                                                         jintArray outSuggestionCount,
                                                         jintArray outCodePointsArray,
                                                         jintArray outScoresArray,
                                                         jintArray outSpaceIndicesArray,
                                                         jintArray outTypesArray,
...
// the dictionary does not have a next word.
    static jint latinime_BinaryDictionary_getNextWord(JNIEnv *env, jclass clazz,
                                                      jlong dict, jint token,
                                                      jintArray outCodePoints,
                                                      jbooleanArray outIsBeginningOfSentence) {
        Dictionary *dictionary = reinterpret_cast<Dictionary *>(dict);
        if (!dictionary) return 0;
        ...
        JniDataUtils::outputCodePoints(env, outCodePoints, 0 /* start */,
                                       MAX_WORD_LENGTH /* maxLength */, wordCodePoints,
                                       wordCodePointCount,
                                       false /* needsNullTermination */);
    ...
    static void latinime_BinaryDictionary_getWordProperty(JNIEnv *env, jclass clazz,
                                                          jlong dict, jintArray word,
                                                          jboolean isBeginningOfSentence,
                                                          jintArray outCodePoints,
                                                          jbooleanArray outFlags,
                                                          jintArray outProbabilityInfo,
                                                          jobject outNgramPrevWordsArray,
                                                          jobject outNgramPrevWordIsBeginningOfSentenceArray,
                                                          jobject outNgramTargets,
                                                          jobject outNgramProbabilityInfo,
                                                          jobject outShortcutTargets,
        ...
        JniDataUtils::outputWordProperty(env, wordProperty, outCodePoints, outFlags,
                                         outProbabilityInfo,
    ...
    static bool latinime_BinaryDictionary_addUnigramEntry(JNIEnv *env, jclass clazz, jlong dict,
        ...
        const UnigramProperty unigramProperty(isBeginningOfSentence, isNotAWord,
                                              ...
                                              HistoricalInfo(timestamp, 0 /* level */,
...
// Returns how many input events are processed.
    static int latinime_BinaryDictionary_updateEntriesForInputEvents(JNIEnv *env, jclass clazz,
        ...
        jfieldID prevWordCountFieldId = env->GetFieldID(wordInputEventClass, "mPrevWordsCount",
                                                        "I");
        jfieldID prevWordArrayFieldId = env->GetFieldID(wordInputEventClass, "mPrevWordArray",
                                                        "[[I");
        ...
        for (int i = startIndex; i < inputEventCount; ++i) {
            ...
            jobjectArray prevWordArray =
                    static_cast<jobjectArray>(env->GetObjectField(inputEvent,
                                                                  prevWordArrayFieldId));
    ...
    static bool latinime_BinaryDictionary_migrateNative(JNIEnv *env, jclass clazz, jlong dict,
                                                        jstring dictFilePath,
                                                        jlong newFormatVersion) {
        Dictionary *dictionary = reinterpret_cast<Dictionary *>(dict);
        if (!dictionary) {
            return false;
        }
        ...
        DictionaryStructureWithBufferPolicy::StructurePolicyPtr dictionaryStructureWithBufferPolicy =
                DictionaryStructureWithBufferPolicyFactory::newPolicyForOnMemoryDict(
                        newFormatVersion, *headerPolicy->getLocale(),
                        headerPolicy->getAttributeMap());
        if (!dictionaryStructureWithBufferPolicy) {
    ...
    static const JNINativeMethod sMethods[] = {
            ...
            },
            {
                    ...
                    const_cast<char *>(
                            "(J[Lpl/rkbdi/anboard/inputmethod/latin/utils/WordInputEventForPersonalization;I)I"),
    ...
    int register_BinaryDictionary(JNIEnv *env) {
        const char *const kClassPathName = "pl/rkbdi/anboard/inputmethod/latin/BinaryDictionary";
