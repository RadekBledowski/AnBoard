...
namespace latinime {
    namespace {
        ...
        i<CAPACITY;
        ++i) {
        EXPECT_NE(nullptr, dicNodePool.

        getInstance()

        );
    }
    EXPECT_EQ(nullptr, dicNodePool.
...
dicNodePool.
placeBackInstance(dicNode);
EXPECT_EQ(dicNode, dicNodePool
.
