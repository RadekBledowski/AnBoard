...
namespace latinime {
    ...
    EXPECT_TRUE(buffer
    .writeUint(0xFF /* data */, 4 /* size */, 0 /* pos */));
    EXPECT_EQ(4, buffer.
    ...
    EXPECT_TRUE(buffer
    .writeUint(0xFFFF /* data */, 4 /* size */, 8 /* pos */));
    EXPECT_TRUE(buffer
    .writeUint(0xFF /* data */, 4 /* size */, 0 /* pos */));
}
...
EXPECT_FALSE(emptyBuffer
.writeUint(0 /* data */, 1 /* size */, 0 /* pos */));
EXPECT_FALSE(emptyBuffer
.extend(1 /* size */));

BufferWithExtendableBuffer smallBuffer(4 /* maxAdditionalBufferSize */);
EXPECT_TRUE(smallBuffer
.writeUint(0 /* data */, 4 /* size */, 0 /* pos */));
EXPECT_FALSE(smallBuffer
.writeUint(0 /* data */, 1 /* size */, 4 /* pos */));
...
EXPECT_TRUE(buffer
.writeUintAndAdvancePosition(0 /* data */, 4 /* size */, &pos));
}
EXPECT_GT(pos,
0);
