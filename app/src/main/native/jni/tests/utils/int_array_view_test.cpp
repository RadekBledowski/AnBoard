...
EXPECT_EQ(expectedIndex, intArrayView
.
...
EXPECT_EQ(ARRAY_SIZE, intArrayView
.
...
const std::vector<int> intVector = {3, 2, 1, 0, -1, -2};
IntArrayView intArrayView(intVector);
EXPECT_EQ(intVector, intArrayView
.
...
EXPECT_EQ(std::vector<int>(), CodePointArrayView()
...
EXPECT_EQ(1u, intArrayViews.

size()

);
EXPECT_TRUE(intArrayViews[0]
.
...
EXPECT_EQ(3u, intArrayViews.

size()

);
EXPECT_EQ(std::vector<int>({1}), intArrayViews[0]
.

toVector()

);
EXPECT_EQ(std::vector<int>({3, 3}), intArrayViews[1]
.

toVector()

);
EXPECT_EQ(std::vector<int>({3}), intArrayViews[2]
.
...
EXPECT_EQ(std::vector<int>({3, 3, 2, 3}), intArrayViews[1]
.
...
EXPECT_EQ(intVector, intArrayViews[0]
.
...
EXPECT_EQ(4u, intArrayViews.

size()

);
EXPECT_EQ(std::vector<int>({1, 2}), intArrayViews[0]
.
...
EXPECT_EQ(std::vector<int>(), intArrayViews[1]
...
EXPECT_EQ(std::vector<int>({2}), intArrayViews[2]
.
...
EXPECT_EQ(std::vector<int>(), intArrayViews[3]
