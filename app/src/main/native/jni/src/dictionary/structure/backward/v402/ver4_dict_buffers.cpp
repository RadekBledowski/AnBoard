...
/* static */ Ver4DictBuffers::Ver4DictBuffersPtr Ver4DictBuffers::openVer4DictBuffers(
                ...
                return Ver4DictBuffersPtr(
                        new Ver4DictBuffers(dictPath, std::move(headerBuffer), isUpdatable,
                                            formatVersion));
            }
            ...
            Ver4DictBuffers::Ver4DictBuffers(const char *const dictPath,
                    ...
                    : mHeaderBuffer(std::move(headerBuffer)),
                      mDictBuffer(MmappedBuffer::openBuffer(dictPath,
                                                            Ver4DictConstants::TRIE_FILE_EXTENSION,
                                                            isUpdatable)),
                      mHeaderPolicy(mHeaderBuffer->getReadOnlyByteArrayView().data(),
                                    formatVersion),
            ...
            Ver4DictBuffers::Ver4DictBuffers(const HeaderPolicy *const headerPolicy,
                    ...
                    : mHeaderBuffer(nullptr), mDictBuffer(nullptr), mHeaderPolicy(headerPolicy),
                      ...
                      mBigramDictContent(headerPolicy->hasHistoricalInfoOfWords()),
