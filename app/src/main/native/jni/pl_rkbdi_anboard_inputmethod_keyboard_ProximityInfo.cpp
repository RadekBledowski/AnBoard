...
#include "pl_rkbdi_anboard_inputmethod_keyboard_ProximityInfo.h"
...
namespace latinime {
    ...
    static jlong latinime_Keyboard_setProximityInfo(JNIEnv *env, jclass clazz,
                                                    ...
                                                    jint mostCommonkeyWidth,
                                                    jint mostCommonkeyHeight,
                                                    jintArray proximityChars, jint keyCount,
                                                    jintArray keyXCoordinates,
                                                    jintArray keyYCoordinates, jintArray keyWidths,
                                                    jintArray keyHeights, jintArray keyCharCodes,
                                                    jfloatArray sweetSpotCenterXs,
                                                    jfloatArray sweetSpotCenterYs,
                                                    jfloatArray sweetSpotRadii) {
        ProximityInfo *proximityInfo = new ProximityInfo(env, displayWidth, displayHeight,
                                                         gridWidth, gridHeight, mostCommonkeyWidth,
                                                         mostCommonkeyHeight, proximityChars,
                                                         keyCount, keyXCoordinates, keyYCoordinates,
    ...
    int register_ProximityInfo(JNIEnv *env) {
        const char *const kClassPathName = "pl/rkbdi/anboard/inputmethod/keyboard/ProximityInfo";
