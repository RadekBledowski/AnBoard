...
// Also caches the bigrams if there is space remaining and they have not been cached already.
    ...
    void
    MultiBigramMap::BigramMap::onVisitEntry(const int ngramProbability, const int targetWordId) {
    ...
    int MultiBigramMap::readBigramProbabilityFromBinaryDictionary(
        ...
        const int bigramProbability = structurePolicy->getProbabilityOfWord(prevWordIds,
                                                                            nextWordId);
