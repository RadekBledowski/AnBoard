    ...
    namespace dicttoolkit {
        namespace {
            ...
            const WordProperty getDummpWordProperty(const std::vector<int> &&codePoints) {
                return WordProperty(std::move(codePoints), UnigramProperty(),
                                    std::vector<NgramProperty>());
            }

            TEST(OffdeviceIntermediateDictTest, TestAddWordProperties
            ) {
            OffdeviceIntermediateDict dict = OffdeviceIntermediateDict(
                    OffdeviceIntermediateDictHeader(
                            OffdeviceIntermediateDictHeader::AttributeMap()));
            EXPECT_EQ(nullptr, dict.

            getWordProperty (CodePointArrayView())
            ...
            EXPECT_TRUE(dict
            .
            addWord(wordProperty0)
            );
            EXPECT_NE(nullptr, dict.
            getWordProperty(wordProperty0
            .
            ...
            EXPECT_TRUE(dict
            .
            addWord(wordProperty1)
            );
            EXPECT_NE(nullptr, dict.
            getWordProperty(wordProperty1
            .
            ...
            EXPECT_TRUE(dict
            .
            addWord(wordProperty2)
            );
            EXPECT_NE(nullptr, dict.
            getWordProperty(wordProperty2
            .
            ...
            EXPECT_TRUE(dict
            .
            addWord(wordProperty3)
            );
            EXPECT_NE(nullptr, dict.
            getWordProperty(wordProperty3
            .
            ...
            EXPECT_TRUE(dict
            .
            addWord(wordProperty4)
            );
            EXPECT_NE(nullptr, dict.
            getWordProperty(wordProperty4
            .
            ...
            EXPECT_TRUE(dict
            .
            addWord(wordProperty5)
            );
            EXPECT_NE(nullptr, dict.
            getWordProperty(wordProperty5
            .
            ...
            EXPECT_FALSE(dict
            .
            addWord(wordProperty6)
            ) << "Adding the same word multiple times should fail.";
