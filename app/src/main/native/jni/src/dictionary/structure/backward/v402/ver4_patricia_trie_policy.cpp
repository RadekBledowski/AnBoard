...
// BinaryDictionaryDecayingTests.
            ...
            const WordAttributes Ver4PatriciaTriePolicy::getWordAttributesInContext(
                ...
                if (multiBigramMap) {
                    const int probability = multiBigramMap->getBigramProbability(
                ...
                return getWordAttributes(
                        getProbability(ptNodeParams.getProbability(), NOT_A_PROBABILITY),
                        ptNodeParams);
            }

            const WordAttributes Ver4PatriciaTriePolicy::getWordAttributes(const int probability,
                                                                           const PtNodeParams &ptNodeParams) const {
                return WordAttributes(probability, false /* isBlacklisted */,
            ...
            int Ver4PatriciaTriePolicy::getBigramConditionalProbability(
                ...
                if (mHeaderPolicy->hasHistoricalInfoOfWords()) {
                    ...
                    return std::min(
                            MAX_PROBABILITY - prevWordUnigramProbability + bigramProbability,
                            MAX_PROBABILITY);
                } else {
            ...
            BinaryDictionaryShortcutIterator Ver4PatriciaTriePolicy::getShortcutIterator(
                    const int wordId) const {
                const int shortcutPos = getShortcutPositionOfPtNode(
                        getTerminalPtNodePosFromWordId(wordId));
            ...
            bool
            Ver4PatriciaTriePolicy::removeUnigramEntry(const CodePointArrayView wordCodePoints) {
                if (!mBuffers->isUpdatable()) {
            ...
            bool Ver4PatriciaTriePolicy::addNgramEntry(const NgramProperty *const ngramProperty) {
                ...
                const WordIdArrayView prevWordIds = ngramContext->getPrevWordIds(this,
                                                                                 &prevWordIdArray,
            ...
            bool Ver4PatriciaTriePolicy::updateEntriesForWordWithNgramContext(
                ...
                const int probability = isValidWord ? DUMMY_PROBABILITY_FOR_VALID_WORDS
                                                    : NOT_A_PROBABILITY;
                const UnigramProperty unigramProperty(false /* representsBeginningOfSentence */,
                                                      false /* isNotAWord */,
                                                      false /*isBlacklisted*/, probability,
                                                      historicalInfo);
                ...
                const int probabilityForNgram = ngramContext->isNthPrevWordBeginningOfSentence(
                        1 /* n */)
                                                ? NOT_A_PROBABILITY : probability;
                const NgramProperty ngramProperty(*ngramContext, wordCodePoints.toVector(),
                                                  probabilityForNgram,
                                                  historicalInfo);
            ...
            bool Ver4PatriciaTriePolicy::needsToRunGC(const bool mindsBlockByGC) const {
                ...
                if (mBuffers->isNearSizeLimit()) {
                    ...
                    return true;
                        ...
                        mDictBuffer->getTailPosition() >= MIN_DICT_SIZE_TO_REFUSE_DYNAMIC_OPERATIONS
                ...
                if (bigramListPos != NOT_A_DICT_POS) {
                    ...
                    while (hasNext) {
                        ...
                        const int codePointCount = getCodePointsAndReturnCodePointCount(
                                getWordIdFromTerminalPtNodePos(word1TerminalPtNodePos),
                                MAX_WORD_LENGTH,
                        ...
                        const int probability = getBigramConditionalProbability(
                        ...
                        ngrams.emplace_back(
                                ...
                                CodePointArrayView(bigramWord1CodePoints,
            ...
            int Ver4PatriciaTriePolicy::getNextWordAndNextToken(const int token,
                ...
                *outCodePointCount = getCodePointsAndReturnCodePointCount(
                        getWordIdFromTerminalPtNodePos(terminalPtNodePos), MAX_WORD_LENGTH,
                        outCodePoints);
