    ...
    namespace backward {
        namespace v402 {
            ...
            const BigramEntry BigramDictContent::getBigramEntryAndAdvancePosition(
                ...
                if (*bigramEntryPos < 0 ||
                    bigramEntryTailPos > bigramListBuffer->getTailPosition()) {
            ...
            bool BigramDictContent::writeBigramEntryAndAdvancePosition(
                ...
                if (!bigramListBuffer->writeUintAndAdvancePosition(bigramFlags,
                                                                   Ver4DictConstants::BIGRAM_FLAGS_FIELD_SIZE,
                                                                   entryWritingPos)) {
            ...
            bool BigramDictContent::runGC(
                ...
                for (TerminalPositionLookupTable::TerminalIdMap::const_iterator it = terminalIdMap->begin();
                    ...
                    if (!runGCBigramList(originalBigramListPos, originalBigramDictContent,
                                         bigramListPos,
...
// Returns whether GC for the bigram list was succeeded or not.
            bool BigramDictContent::runGCBigramList(const int bigramListPos,
                                                    const BigramDictContent *const sourceBigramDictContent,
                                                    const int toPos,
                                                    const TerminalPositionLookupTable::TerminalIdMap *const terminalIdMap,
                ...
                while (hasNext) {
                    ...
                    if (originalBigramEntry.getTargetTerminalId() ==
                        Ver4DictConstants::NOT_A_TERMINAL_ID) {
                        continue;
                    }
                ...
                if (lastEntryPos != NOT_A_DICT_POS) {
                    ...
                    const BigramEntry bigramEntry = getBigramEntry(
                            lastEntryPos).updateHasNextAndGetEntry(
                            false /* hasNext */);
