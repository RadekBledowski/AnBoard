...
#include "pl_rkbdi_anboard_inputmethod_latin_BinaryDictionaryUtils.h"
#include "pl_rkbdi_anboard_inputmethod_latin_DicTraverseSession.h"
#include "defines.h"
...
namespace latinime {
    int
    registerNativeMethods(JNIEnv *env, const char *const className, const JNINativeMethod *methods,
