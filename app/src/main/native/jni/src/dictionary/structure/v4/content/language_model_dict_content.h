 ...
 */
    ...
    public:
        ...
        const WordAttributes getWordAttributes(const WordIdArrayView prevWordIds, const int wordId,
                                               const bool mustMatchAllPrevWords,
        ...
        bool updateAllProbabilityEntriesForGC(const HeaderPolicy *const headerPolicy,
            ...
            if (!updateAllProbabilityEntriesForGCInner(mTrieMap.getRootBitmapEntryIndex(),
                                                       0 /* prevWordCount */, headerPolicy,
                                                       mGlobalCounters.needsToHalveCounters(),
                                                       outEntryCounters)) {
                return false;
            }
        ...
        bool
        truncateEntries(const EntryCounts &currentEntryCounts, const EntryCounts &maxEntryCounts,
    ...
    private:
        ...
        bool
        updateAllProbabilityEntriesForGCInner(const int bitmapEntryIndex, const int prevWordCount,
                                              const HeaderPolicy *const headerPolicy,
        ...
        const ProbabilityEntry
        createUpdatedEntryFrom(const ProbabilityEntry &originalProbabilityEntry,
                               const bool isValid, const HistoricalInfo historicalInfo,
                               const HeaderPolicy *const headerPolicy) const;
