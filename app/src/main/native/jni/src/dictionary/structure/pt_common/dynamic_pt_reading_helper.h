 ...
 */
    ...
    public:
        ...
        fetchMergedNodeCodePointsInReverseOrder(const PtNodeParams &ptNodeParams,
        ...
        int
        getCodePointsAndReturnCodePointCount(const int maxCodePointCount, int *const outCodePoints);
