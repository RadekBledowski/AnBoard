...
EXPECT_EQ(-1,
HeaderReadWriteUtils::readIntAttributeValue(&attributeMap,
"", -1));
EXPECT_EQ(100,
HeaderReadWriteUtils::readIntAttributeValue(&attributeMap,
"abc", 100));

HeaderReadWriteUtils::setIntAttribute(&attributeMap,
"abc", 10);
EXPECT_EQ(10,
HeaderReadWriteUtils::readIntAttributeValue(&attributeMap,
"abc", 100));
...
EXPECT_TRUE(HeaderReadWriteUtils::readCodePointVectorAttributeValue(&attributeMap, "")
.
...
HeaderReadWriteUtils::setCodePointVectorAttribute(&attributeMap,
"abc", {
});
EXPECT_TRUE(HeaderReadWriteUtils::readCodePointVectorAttributeValue(
        &attributeMap, "abc")
