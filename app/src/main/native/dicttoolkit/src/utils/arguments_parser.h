...
namespace latinime {
    namespace dicttoolkit {
        ...
        private:
            OptionSpec(const bool needsValue, const std::string &valueName,
        ...
        public:
            ...
            static ArgumentSpec
            singleArgument(const std::string &name, const std::string &description) {
        ...
        private:
            ...
            ArgumentSpec(const std::string &name, const size_t minCount, const size_t maxCount,
                         const std::string &description)
                    : mName(name), mMinCount(minCount), mMaxCount(maxCount),
                      mDescription(description) {}
        ...
        public:
            ArgumentsParser(const std::unordered_map <std::string, OptionSpec> &&optionSpecs,
                    ...
                    : mOptionSpecs(std::move(optionSpecs)),
                      mArgumentSpecs(std::move(argumentSpecs)) {}
