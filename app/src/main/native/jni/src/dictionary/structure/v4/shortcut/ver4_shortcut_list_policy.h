...
namespace latinime {
    ...
    public:
        ...
        void getNextShortcut(const int maxCodePointCount, int *const outCodePoint,
                             int *const outCodePointCount, bool *const outIsWhitelist,
        ...
        bool
        addNewShortcut(const int terminalId, const int *const codePoints, const int codePointCount,
            ...
            if (shortcutListPos == NOT_A_DICT_POS) {
                ...
                return mShortcutDictContent->writeShortcutEntry(codePoints, codePointCount,
                                                                probability,
            ...
            mShortcutDictContent->getShortcutEntry(MAX_WORD_LENGTH, 0 /* outCodePoint */,
                                                   0 /* outCodePointCount */ , 0 /* probability */,
                                                   &hasNext, entryPos);
            if (!mShortcutDictContent->writeShortcutEntry(codePoints,
                                                          codePointCount, probability, hasNext,
                                                          entryPos)) {
