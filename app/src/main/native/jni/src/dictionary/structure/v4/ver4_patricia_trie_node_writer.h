 ...
 */
    ...
    public:
        Ver4PatriciaTrieNodeWriter(BufferWithExtendableBuffer *const trieBuffer,
                ...
                : mTrieBuffer(trieBuffer), mBuffers(buffers),
                  mReadingHelper(ptNodeReader, ptNodeArrayReader),
        ...
        virtual bool updatePtNodeProbabilityAndGetNeedsToKeepPtNodeAfterGC(
                const PtNodeParams *const toBeUpdatedPtNodeParams,
                bool *const outNeedsToKeepPtNode);
        ...
        virtual bool
        writeNewTerminalPtNodeAndAdvancePosition(const PtNodeParams *const ptNodeParams,
                                                 const UnigramProperty *const unigramProperty,
                                                 int *const ptNodeWritingPos);
    ...
    private:
        ...
        bool
        updatePtNodeFlags(const int ptNodePos, const bool isTerminal, const bool hasMultipleChars);
