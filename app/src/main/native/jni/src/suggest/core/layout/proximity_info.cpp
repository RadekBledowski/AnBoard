...
namespace latinime {
    ...
    ProximityInfo::ProximityInfo(JNIEnv *env, const int keyboardWidth, const int keyboardHeight,
                                 ...
                                 const int mostCommonKeyHeight, const jintArray proximityChars,
                                 const int keyCount,
                                 const jintArray keyXCoordinates, const jintArray keyYCoordinates,
                                 const jintArray keyWidths, const jintArray keyHeights,
                                 const jintArray keyCharCodes,
                                 const jfloatArray sweetSpotCenterXs,
                                 const jfloatArray sweetSpotCenterYs,
            ...
            : GRID_WIDTH(gridWidth), GRID_HEIGHT(gridHeight),
              ...
              NORMALIZED_SQUARED_MOST_COMMON_KEY_HYPOTENUSE(1.0f +
                                                            GeometryUtils::SQUARE_FLOAT(
                                                                    static_cast<float>(mostCommonKeyHeight) /
