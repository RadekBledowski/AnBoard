...
namespace latinime {
    namespace backward {
        namespace v402 {
            ...
            void
            ShortcutDictContent::getShortcutEntryAndAdvancePosition(const int maxCodePointCount,
            ...
            bool ShortcutDictContent::copyShortcutListFromDictContent(const int shortcutListPos,
                ...
                while (hasNext) {
                    ...
                    sourceShortcutDictContent->getShortcutEntryAndAdvancePosition(MAX_WORD_LENGTH,
                                                                                  ...
                                                                                  &hasNext,
                                                                                  &readingPos);
                    if (!writeShortcutEntryAndAdvancePosition(codePoints, codePointCount,
                                                              probability,
                                                              hasNext, &writingPos)) {
            ...
            bool
            ShortcutDictContent::setProbability(const int probability, const int shortcutEntryPos) {
            ...
            bool
            ShortcutDictContent::writeShortcutEntryAndAdvancePosition(const int *const codePoint,
                ...
                if (!shortcutListBuffer->writeCodePointsAndAdvancePosition(codePoint,
                                                                           codePointCount,
