...
namespace latinime {
    ...
    bool Ver4PatriciaTrieWritingHelper::writeToDictFile(const char *const dictDirPath,
        ...
        if (!headerPolicy->fillInAndWriteHeaderToBuffer(false /* updatesLastDecayedTime */,
                                                        entryCounts, extendedRegionSize,
                                                        &headerBuffer)) {
    ...
    bool Ver4PatriciaTrieWritingHelper::runGC(const int rootPtNodeArrayPos,
                                              ...
                                              Ver4DictBuffers *const buffersToWrite,
        ...
        Ver4PatriciaTrieNodeWriter ptNodeWriter(mBuffers->getWritableTrieBuffer(),
                                                mBuffers, &ptNodeReader, &ptNodeArrayReader,
                                                &shortcutPolicy);
        ...
        readingHelper.initWithPtNodeArrayPos(rootPtNodeArrayPos);
        Ver4PatriciaTrieNodeWriter ptNodeWriterForNewBuffers(
                buffersToWrite->getWritableTrieBuffer(),
        ...
        Ver4PatriciaTrieNodeWriter newPtNodeWriter(buffersToWrite->getWritableTrieBuffer(),
                                                   buffersToWrite, &newPtNodeReader,
                                                   &newPtNodeArrayreader,
                                                   &newShortcutPolicy);
        ...
        DynamicPtGcEventListeners::TraversePolicyToUpdateAllPositionFields
                traversePolicyToUpdateAllPositionFields(&newPtNodeWriter,
                                                        &dictPositionRelocationMap);
        ...
        TraversePolicyToUpdateAllPtNodeFlagsAndTerminalIds
                traversePolicyToUpdateAllPtNodeFlagsAndTerminalIds(&newPtNodeWriter,
                                                                   &terminalIdMap);
