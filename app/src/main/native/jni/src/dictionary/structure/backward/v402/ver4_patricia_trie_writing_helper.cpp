    ...
    namespace backward {
        namespace v402 {
            ...
            bool Ver4PatriciaTrieWritingHelper::writeToDictFile(const char *const dictDirPath,
                ...
                if (!headerPolicy->fillInAndWriteHeaderToBuffer(false /* updatesLastDecayedTime */,
                    ...
                    AKLOGE("Cannot write header structure to buffer. "
                           ...
                           "extendedRegionSize: %d", false,
                           entryCounts.getNgramCount(NgramType::Unigram),
            ...
            bool Ver4PatriciaTrieWritingHelper::writeToDictFileWithGC(const int rootPtNodeArrayPos,
                ...
                int unigramCount = 0;
                int bigramCount = 0;
                if (!runGC(rootPtNodeArrayPos, headerPolicy, dictBuffers.get(), &unigramCount,
                           &bigramCount)) {
                    return false;
                }
                BufferWithExtendableBuffer headerBuffer(
            ...
            bool Ver4PatriciaTrieWritingHelper::runGC(const int rootPtNodeArrayPos,
                ...
                Ver4PatriciaTrieNodeWriter ptNodeWriter(mBuffers->getWritableTrieBuffer(),
                                                        mBuffers, headerPolicy, &ptNodeReader,
                                                        &ptNodeArrayReader, &bigramPolicy,
                                                        &shortcutPolicy);
                ...
                const int maxUnigramCount = headerPolicy->getMaxNgramCounts().getNgramCount(
                        NgramType::Unigram);
                ...
                const int maxBigramCount = headerPolicy->getMaxNgramCounts().getNgramCount(
                        NgramType::Bigram);
                ...
                Ver4BigramListPolicy newBigramPolicy(buffersToWrite->getMutableBigramDictContent(),
                                                     ...
                                                     headerPolicy);
                Ver4ShortcutListPolicy newShortcutPolicy(
                        buffersToWrite->getMutableShortcutDictContent(),
                        buffersToWrite->getTerminalPositionLookupTable());
                Ver4PatriciaTrieNodeWriter newPtNodeWriter(buffersToWrite->getWritableTrieBuffer(),
                                                           buffersToWrite, headerPolicy,
                ...
                DynamicPtReadingHelper newDictReadingHelper(&newPtNodeReader,
            ...
            bool Ver4PatriciaTrieWritingHelper::truncateUnigrams(
                ...
                while (static_cast<int>(priorityQueue.size()) > maxUnigramCount) {
                    ...
                    if (!ptNodeWriter->markPtNodeAsWillBecomeNonTerminal(&ptNodeParams)) {
                        AKLOGE("Cannot mark PtNode as willBecomeNonterminal. PtNode pos: %d",
                               ptNodePos);
                        return false;
                    }
                }
