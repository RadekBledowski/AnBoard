    ...
    namespace backward {
        namespace v402 {
            ...
            public:
                ...
                bool writeToDictFile(const char *const dictDirPath,
                ...
                bool
                writeToDictFileWithGC(const int rootPtNodeArrayPos, const char *const dictDirPath);
