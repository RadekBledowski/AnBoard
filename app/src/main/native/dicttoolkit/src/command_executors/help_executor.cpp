...
/* static */ int HelpExecutor::run(const int argc, char **argv) {
            ...
            const std::vector <std::function<void(void)>> printUsageMethods = {
                    DiffExecutor::printUsage,
                    HeaderExecutor::printUsage, InfoExecutor::printUsage,
                    MakedictExecutor::printUsage,
                    printUsage};
